package com.yuyang.popupwindowview;
...
import com.yuyang.popupwindowview.view.CommonPopupWindow;
 ...
 */
class PopupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();   //初始化PopupWindow中ListView 数据
        initPopupWindow();  //创建PopupWindow
        initView();
    }
